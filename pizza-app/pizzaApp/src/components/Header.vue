    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <ul class="navbar-nav">
                ...
                <li><router-link :to="{name:'hotpizzaLink'}" class="nav-link">销售分析</router-link></li>
             ...
             <ul class="navbar-nav ml-auto">
                <li class="nav-link">{{currentUser.email}}</li>
                <li v-if="!isLogin"><router-link :to="{name:'loginLink'}" class="nav-link">登录</router-link></li>
                <li class="nav-link" v-else>
                    <a @click="signOut">[退出]</a>
                </li>
                <li v-if="!isLogin"><router-link :to="{name:'registerLink'}" class="nav-link">注册</router-link></li>
            </ul>
        </nav>
    </header>
</template>
